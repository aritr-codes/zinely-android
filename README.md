...
| [docs/COMPOSE-V2-ROADMAP.md](docs/COMPOSE-V2-ROADMAP.md) | *What*, in order — phases A–F with their deliverables, acceptance criteria and review gates, plus the **[Phase A completion record](docs/COMPOSE-V2-ROADMAP.md#phase-a-completion-record-2026-07-29)**: what was actually built, what was built differently than planned, and the two criteria Phase A could not meet |
