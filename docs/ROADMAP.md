...
| `0.6.0-alpha.1` | S7 — first installable alpha (early testers) | 🔜 in flight — S7.0 import fix ✅, S7.1 A4-at-create + alpha scope record ([ADR-047](DECISIONS.md#adr-047)) ✅; gated on the **physical print test** (print at 100%, fold, verify 1→8 order/rotation/scale), then version bump + tag |
