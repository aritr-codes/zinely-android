...
| ☑ | ~~[D-080](design/V2-SPEC-DEFECTS.md#d-080) + [D-107](design/V2-SPEC-DEFECTS.md#d-107)~~ | **CLOSED 2026-08-26 — A16's combined Art + Ink iteration is DESIGN FROZEN.** The owner accepted the named three-column material cabinet, compact family filters, Recent/Favourites rails, visible current ink, stable 5×2 ink grid and honestly labelled starting palettes. | Compose implementation is authorised against A16; document/render semantics are unchanged |
