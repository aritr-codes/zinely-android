...
| ☐ | [D-081 Q10](design/V2-SPEC-DEFECTS.md#d-081) | Seed consecutive share-in batches from images already on the page | D-052's text route is closed by A12; the "it lost my photo" misread on consecutive one-photo shares remains |
